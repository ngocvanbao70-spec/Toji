...
RunService.Heartbeat:Connect(function()
    ...
    if NoclipEnabled or IsTelePro or IsTelePro2 or IsChonTele then
...
LocalPlayer.Chatted:Connect(function(msg)
    ...
    if args[1]:lower() == ";luka" then
        ...
        -- CHỈNH TỌA ĐỘ LỆCH (Dùng chung cho Tele Pro, Tele Pro 2, Chọn Tele)
        ...
        elseif cmd == "unblock" then
            ...
            pcall(function()
                CombatRemote:FireServer("Unblock")
            end)
